...
def train_rf(x_train: scipy.sparse._csr.csr_matrix,
    ...
    with mlflow.start_run():
        ...
        with open("models/preprocessor.a", "wb") as f_out:
            joblib.dump(model, f_out)
        mlflow.log_artifact("models/preprocessor.a", artifact_path="preprocessor1")

        #mlflow.log(model, artifact_path="models_mlflow")
    return None
...
def main(
        train_path: str = '/Users/mandeebot/Desktop/fin_project/data/data_combined.csv'
) -> None:
